...
class AuthorServiceImplTest {
    ...
    public void readAllAuthorsTest() {
        List<Author> listOfAuthors = List.of(author);
        given(authorRepository.readAll(1, 10, "id::asc")).willReturn(listOfAuthors);

        //then
        assertThat(authorService.readAll(1, 10, "id::asc")).isEqualTo(authorDtoMapper.modelListToDtoList(listOfAuthors));
    }
