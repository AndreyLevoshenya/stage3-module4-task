...
class TagServiceImplTest {
    ...
    public void readAllTagsTest() {
        List<Tag> listOfTags = List.of(tag);
        given(tagRepository.readAll(1, 10, "id::asc")).willReturn(listOfTags);

        //then
        assertThat(tagService.readAll(1, 10, "id::asc")).isEqualTo(tagDtoMapper.modelListToDtoList(listOfTags));
    }
