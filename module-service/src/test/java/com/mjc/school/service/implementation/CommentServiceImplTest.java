...
class CommentServiceImplTest {
    ...
    public void readAllCommentsTest() {
        //given
        List<Comment> listOfComments = List.of(comment);
        given(commentRepository.readAll(1, 10, "id::asc")).willReturn(listOfComments);

        //then
        assertThat(commentService.readAll(1, 10, "id::asc")).isEqualTo(commentDtoMapper.modelListToDtoList(listOfComments, newsDtoMapper));
    }
