...
public class AuthorControllerImplV1 implements AuthorController {
    private final AuthorService authorService;

    @Autowired
    public AuthorControllerImplV1(AuthorService authorService) {
    ...
    public ResponseEntity<AuthorDtoResponse> readByNewsId(@RequestParam Long newsId) {
