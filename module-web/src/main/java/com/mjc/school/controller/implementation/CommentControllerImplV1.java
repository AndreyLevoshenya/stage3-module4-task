...
public class CommentControllerImplV1 implements CommentController {
    private final CommentService commentService;

    @Autowired
    public CommentControllerImplV1(CommentService commentService) {
    ...
    @Override
    @GetMapping(value = "/get", params = "version=1")
    public ResponseEntity<List<CommentDtoResponse>> readByNewsId(@RequestParam Long newsId) {
